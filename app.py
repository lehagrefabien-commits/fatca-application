...
def generate():
    ...
    # 2) Champs du formulaire (nouvelle version)
    ...
    # Reconstitution des champs attendus par le template Word
    nom_prenom = f"{prenom} {nom}"
    cp_ville = f"{code_postal} {ville}"

    # IMPORTANT : « Lieu » = ville de l'expéditeur
    lieu = ville
    ...
    # 4) Date du courrier (automatique)
